...
desired_order <- c("model2p", "model1p", "model0p",
...
plot_all <- ggplot(combined_legume_results %>% filter(model %in% c("model0t", "model1t", "model2t", "model0r", "model1r", "model2r", "model0p", "model1p", "model2p")),
