...
newdata <- expand_grid(
  smoking = c("Never", "Previous", "Current"), sex = "Female", education = "High", spouse = "Yes", exercise = "Yes",
  bmi_category = "Overweight", ethnicity = "White",
  diabetes = "No", nafld = "No", cholelith = "No", cystectomy = "No"
)
survfit(fit, newdata) |>
...
newdata <- expand_grid(
  ethnicity = c("White", "Other"), sex = "Female", education = "High", spouse = "Yes", exercise = "Yes", smoking = "Current",
