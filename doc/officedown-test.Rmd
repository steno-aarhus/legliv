...
```{r tab.cap="Table 3", tab.id="table3", echo=FALSE}
table_main
```

\newpage

```{r fig.width= 10, fig.height= 7, fig.cap="Figure 1. Flowchart of included participants."}
knitr::opts_chunk$set(dpi = 300)
source(here("R", "flowchart.R"))
load(here::here("doc", "flowchart.rda"))
flowchart
```
