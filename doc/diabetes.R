...
#Creating dataset with participants who have one or more of diagnoses "E10" to "E14"
# (tried different filter codes, i.e. filtering for E11.1, and compared with UKB data showcase.
