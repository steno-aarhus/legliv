...
\end{align}
```
When substituting only red meat with legumes, processed red meat was
added to the model:
...
\end{align}
```
When substituting only processed red meat with legumes, red meat was
added to the model:
...
for misclassification bias. Lastly, one of our causal assumptions was
that anthropometry confounded the causal relationship between replacing
red meat with legumes and liver cancer; however, strong arguments exist
...
mediator, waist circumference was removed in a sensitivity analysis.
