...
cancer. When stratifying on liver cancer type, replacing total red meat
and unprocessed red meat with legumes was inversely associated with ICC,
though insignificant. The estimates did not change significantly in any
...
cancer and with a greater magnitude than unprocessed red meat. This
tendency was observed across all sensitivity analyses. However, the
estimates for processed red meat were labeled with less confidence due
to the low median intake. These results correspond to a recent analysis
in the UK Biobank on meat intake and cancers, finding that intake of
unprocessed red meat was associated with a non-significant increase in
risk of liver cancer and with a greater magnitude than processed meat
(both white and red meat) [@Knuppel2020], lending support to the
assertion that processed meat is not associated with risk of liver
cancer in this study population.

Stratifying on cancer type revealed that replacing unprocessed red meat
with legumes to some extent was associated with a decreased risk of
liver cancer (Supplementary table 4), contrary to HCC. However, the
robustness of these results were not tested in further analyses as they
...
The literature on food substitutions in general is sparse and almost
non-existent for liver cancer as an outcome. However, a recent
meta-anlysis of observational studies found a non-linear dose-response
relationship between intake of legumes and liver cancer, with a
protective effect occurring between intakes of 8 g/day to 40 g/day
[@liu2023a]. This somewhat stands in opposition to our findings of no
increase above 6.3 g/day of legumes was associated with a decreased risk
of liver cancer, compared to no intake of legumes. A recent
meta-analysis of observational studies no association between red or
processed meat intake and HCC [@Di2023].

## Strength and limitations {#subsec10}

This study had some limitations. First, None of the registries used to
determine a diagnosis of liver cancer were complete or up to date
[@RN112]. Data from external providers, e.g., the NHS England, NHS
Central Register or National Records of Scotland, were estimated to be
mostly complete by the UK Biobank at various dates, ranging from 31
December 2016 for cancer data from Wales to 31 October 2022 for hospital
inpatient data from England [@RN114]. This could introduce
misclassification bias of the outcome as individuals with liver cancer
may not be identified as events. However, the estimates were robust to a
sensitivity analysis where we included death registries as a source of
liver cancer diagnoses in an attempt to accommodate for missing outcome
events.

Second, the relative low number of events limited our efforts of
adjusting for confounding as too many adjustment levels per event can
affect the validity of the multivariable Cox regression model, causing
potential biased estimates. Efforts were made to reach at least 10
events per variable for the main analysis to secure statistical validity
by limiting the number of adjustment levels, i.e., fewer and broader
food groups and fewer levels for categorical covariates. This was done
while respecting our *a priori* causal assumptions. Reaching statistical
validity was a trade-off with increasing residual confounding as the
importance of specific food groups may have been diluted. Risk factors
that we were unable to adjust for may have contributed to residual
confounding; aflatoxin B1 is a known liver carcinogen

Strengths of this study are the large sample size and the prospective
longitudinal design that are strengthening generalisability and
temporality. Estimates were robust to exclusion of participants with
fewer than 3 completed Oxford WebQs, lending support to at least 2
completed Oxford WebQs being sufficient to correct for measurement
errors.
