...
\urlstyle{same}
\hypersetup{
  pdftitle={The Association between Substitution of Red Meat with Legumes and Risk of Primary Liver Cancer in UK Biobank: A Cohort Study},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{The Association between Substitution of Red Meat with Legumes and Risk of Primary Liver Cancer in UK Biobank: A Cohort Study}
\usepackage{authblk}
