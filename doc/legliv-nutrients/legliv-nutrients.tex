...
\TitleCitation{The Association between Substitution of Red Meat with Legumes and Risk of Primary Liver Cancer in UK Biobank: A Cohort Study}
...
\textbf{Characteristic}\textsuperscript{\textit{1}} & \textbf{N = 126,744} & \textbf{N = 173} \\ 
...
\textsuperscript{\textit{1}}Median (Q1, Q3) for continuous variables; n (\%) for categorical variables. Variables are in bold.\\
...
\toprule
 & \textbf{Cohort} & \textbf{Liver cancer} \\ 
\cmidrule(lr){2-2} \cmidrule(lr){3-3}
\textbf{Daily food intake}\textsuperscript{\textit{1}} & \textbf{N = 126,744} & \textbf{N = 173} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{1\linewidth}}{{\bfseries Total food intake}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
Energy, kJ & 8,430 (7,179, 9,856) & 8,579 (7,413, 10,048) \\ 
Weight, g & 3,144 (2,720, 3,621) & 3,162 (2,737, 3,659) \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{1\linewidth}}{{\bfseries Food groups, g/day}} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
