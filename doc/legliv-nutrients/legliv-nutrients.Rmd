...
proteins with plant-based proteins in relations to NAFLD [@Zhang2023],
...
categories [@piernas2021]. These food and beverage groups were used when
...
liver paté. Other food groups included were animal-based foods,
...
indices from previous studies [@Thompson2023; @Heianza2021; @Satija2017;
@Satija2016].
...
implications that an increased intake of a food is at the expense of a
...
observed between intakes of 8 g/day to 40 g/day [@liu2023a]. This
somewhat contrasts with our findings where any increase above 6.3 g/day
of legumes was not associated with a lower risk of liver cancer,
...
HCC [@Di2023] while another found a positive association between
processed meat and HCC [@Yu2022]. Another study examined replacement of
