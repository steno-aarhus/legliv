...
tissues [@Ma2019]. Processed red meat is classified as "carcinogenic to
humans" and unprocessed red meat as a possible carcinogen by the
International Agency for Research on Cancer [@Bouvard2015]. Studies on
substituting animal-based proteins with plant-based proteins are
important if we are to lower the climate impacts of our diets [@RN71].
...
outcome of interest and were guided by our *a priori* assumptions (see
study protcol at **LINK TO PROTOCOL HERE**). Assumptions of proportional
...
cancers [@Dahm2024; @Hu2023]. Despite of the fact that replacement of
