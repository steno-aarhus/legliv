...
infectous and environmental risk factors [@Bergquist2015]. Recent
...
the food groups used in the substitution analyses (Table
...
of 15 g of all red meats (red and processed) with 15 g of legumes, the
...
This was opposite for replacement of total red meat and unprocessed red
meat and ICC (total red meat:
...
Table \ref{tab-cancer}). The magnitude or direction of associations were
not significantly different across strata of liver cancer types.
...
[@Greenwood2019]. We did not adjust for BMI; however, adjusting for
...
were complete or up-to-date at the time of analysis [@RN112]. Data from
...
from England [@RN114]. This could introduce misclassification of the
