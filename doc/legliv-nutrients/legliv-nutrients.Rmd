...
# front matter
abstract: |
  Primary liver cancer is on the rise worldwide, partially due to poor diets and sedentary lifestyles. Shifting to more plant-based diets may lower the risk. We aimed to estimate the effect of replacing total red meat, unprocessed red meat and processed red meat with legumes on primary liver cancer in a free-living population. We analyzed data from 126,744 UK Biobank participants who completed $\geq$ 2 24-hour diet recalls. Baseline characteristics were collected from the initial assessment visit. Information on liver cancer diagnoses was collected via external linkage to inpatient hospital episodes or central cancer registries. Cox proportional hazards regression models were used to estimate substitution of 15 g/day of legumes with 15 g/day of total red meat, unprocessed red meat or processed red meat on liver cancer risk, using the leave-one-out food substitution model. During a median follow-up time of 11.3 years, 173 participants developed liver cancer. In the fully adjusted models, no association was observed when substituting 15 g/day of legumes with total red meat (HR: 1.02 (95% CI 0.96-1.08)), unprocessed red meat (HR: 1.00 (95% CI 0.94-1.06)) or processed red meat (HR: 1.09 (95% CI 0.99-1.21)). Overall, little evidence of an association between replacing red meat with legumes and liver cancer was observed. Further research in other study populations with longer follow-up time is warranted.
# back matter
keywords: |
  Food Substitutions; liver cancer; red meat; legumes.
authorcontributions: |
  Conceptualization, N.B. and F.L.; Methodology, N.B., F.L., D.B.I. and C.C.D.; Software, L.W.J.; Validation, L.W.J.; Formal Analysis, N.B.; Investigation, N.B.; Resources, F.L., L.W.J, D.B.I and C.C.D.; Data Curation, N.B. and L.W.J.; Writing – Original Draft Preparation, N.B.; Writing – Review & Editing, N.B., F.L., D.B.I. and C.C.D.; Visualization, N.B.; Supervision, F.L. and C.C.D.; Project Administration, C.C.D.; Funding Acquisition, N.B. and C.C.D.
funding: |
  This research was funded by the Aarhus University Research Foundation (AUFF) via the Graduate School of Health at Aarhus University.
conflictsofinterest: |
  The authors declare no conflict of interest.
dataavailability: |
  `r ukbAid::statements$paper` Data can be accessed via application to the Access Management System (AMS) at https://www.ukbiobank.ac.uk/enable-your-research/apply-for-access. Showcase of the data are available at https://biobank.ndph.ox.ac.uk/showcase/.
institutionalreview: |
  The UK Biobank was approved by the National Information Governance Board for Health and Social Care and the National Health Service (NHS) North West Multicentre Research Ethics Committee (ref 21/NW/0157).
informedconsent: |
...
source(here("R","table-baseline.R"))
source(here("R","table-diet.R"))
...
legume consumption and risk of HCC [@zhang2013; @Liu2021]. However,
...
concomitantly lower intake of another food. Studies on substituting
animal-based proteins with plant-based proteins are important if we are
to lower the climate impacts of our diets [@RN71]. While previous
research has investigated and found protective effects when substituting
animal-based proteins with plant-based proteins in relations to NAFLD
[@Zhang2023], research on substituting meats with legumes in relation to
risk of HCC and ICC is sparse. This leaves a substantial gap in the
current knowledge on the beneficial effects on primary liver cancer from
...
foods, and alcoholic beverages (Table \@ref(tab:food-group)). Given that
liver cancer is a rare outcome, broad and few food groups were defined
to keep the number of adjustment levels relatively low to maintain
statistical power. Animal-based and healthy and unhealthy plant-based
food foods were grouped based on plant-based diet indices from previous
studies [@Thompson2023; @Heianza2021; @Satija2017; @Satija2016].
...
more Oxford WebQs were eligible for inclusion in this study. The
baseline intake was defined as the average of the reported 24-hour diet
recalls.
...
Confounders were defined *a priori* from a review of the background
...
weight of food and beverage intake, and all other food groups to fit the
...
proportional hazards were checked using Schoenfeld residuals and showed
no violations.
...
liver cancer (HCC = , ICC = ). Those who developed liver cancer were
older at baseline, were more likely to be male, have a higher waist
circumference, be less physically active, and fewer had never smoked,
compared to all included participants (Table \@ref(tab:baseline)).
...
particularly for participants with a higher BMI [@Greenwood2019].
...
Replacing Red meat with legumes will, inevitabely, increase one's intake
of dietary fibres. Soy milk is low in fibres and did constitute a
substantial amount of the legumes food group which would alleviate the
difference in fiber intake from replacing red meat with legumes.
