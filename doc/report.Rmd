...
liver cancer in model 1 (Table 3: total meat: HR: 0.98, 95% CI: 0.93,
1.04; red meat: HR: 0.97, 95% CI: 0.91-1.03; processed meat: HR 1.02,
95% CI: 0.93, 1.13). The estimated associations changed minimally but
remained non-significant with further adjustments (Table 3: total meat:
HR: 1.02, 95% CI: 0.96, 1.08; red meat: HR: 1.00, 95% CI: 0.94-1.07);
processed meat: HR: 1.09, 95% CI: 0.98, 1.20).
