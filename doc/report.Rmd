...
total weight of food intake, and all other foods groups. The adjusted
model was further adjusted for sex, educational level, Townsend
Deprivation Index, living alone, physical activity, smoking status,
...
1.       Exclusion of high alcohol consumers.

2.       Exclusion of food intake misreporters.

3.       Exclusion of participants with any other liver disease before
baseline.

4.       Exclusion of participants with any type of cancer before
baseline.

5.       Exclusion of the first two years of follow-up.

6.       Inclusion criteria for number of completed diet questionnaires
